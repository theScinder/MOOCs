...
%%ty
  momentum = 0.5;
end  % Momentum; default = 0.9.
if (0)
  numhid1 = 50;
  % Dimensionality of embedding space; default = 50.
numhid2 = 200; 
end % Number of units in hidden layer; default = 200.
...
for epoch = 1:epochs
  ...
  for m = 1:numbatches
    ...
    % Options:
    %embedding_layer_state is 150x100
    %bp_derive is 200x100
    % (a) 
    ...
    % Options embed_to_hid_weights is 150x200(a)
    % (a) 
...
model.vocab = vocab;
model.CE = strcat(fprintf(1, '\rFinal Test CE %.3f\n', CE),fprintf(1, '\rFinal Validation CE %.3f\n', CE),fprintf(1, '\rAverage Training CE %.3f\n', trainset_CE));
